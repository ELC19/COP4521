...
ADMIN = ["chashimahiulislam@gmail.com", "elc36118@gmail.com"] #change to your email to be admin
...
def dislike_post(post_id):
    """dislikes if logged in as a user"""
    ...
    existing_dislike = Dislike.query.filter_by(user_id=user.id, post_id=post_id).first()
    if existing_dislike:
        flash('You have already disliked this post.', 'info')
    else:
        new_dislike = Dislike(user_id=user.id, post_id=post_id)
